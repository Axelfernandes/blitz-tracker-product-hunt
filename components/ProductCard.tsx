    ...
    >
      ...
      >
        ...
        <div className="flex items-start gap-3 pr-16">
          <div className="relative h-14 w-14 flex-shrink-0 overflow-hidden rounded-lg border border-black/10 dark:border-white/20 group-hover:border-[#FF958C]/50 transition-colors">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-lg font-bold text-black dark:text-white group-hover:text-[#FF958C] transition-colors line-clamp-1">
              {product.name}
            </h3>
            <p className="text-sm text-black/70 dark:text-white/70 line-clamp-2 leading-relaxed mt-1">
              {product.tagline}
            </p>
          </div>
        </div>
        ...
        {/* Growth Badge */}
        {hasHighGrowth && (
          <div className="flex items-center gap-1 px-2 py-1 rounded-md bg-emerald-500/10 dark:bg-green-500/10 border border-emerald-500/20 dark:border-green-500/20 w-fit">
            <Zap className="w-3 h-3 text-emerald-600 dark:text-green-400" />
            <span className="text-xs text-emerald-600 dark:text-green-400 font-medium">High Growth</span>
          </div>
        )}

        <div className="flex items-center justify-between gap-2 pt-2 mt-auto border-t border-black/10 dark:border-white/5">
